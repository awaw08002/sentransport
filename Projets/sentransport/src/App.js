...
import ListeLignes from './ListesLignes';
...
function App() {
  const lignes = [
    ...
    { id: 8,  numero: "5",  depart: "HLM",                 arrivee: "Dieuppeul",   arrets: 13, couleur: "#d35400" },
    { id: 9,  numero: "19", depart: "Sicap",               arrivee: "Médina",      arrets: 8,  couleur: "#27ae60" },
    { id: 10, numero: "31", depart: "Liberté 6",           arrivee: "Sandaga",     arrets: 15, couleur: "#2c3e50" },
  ];
